          ...
          >
            ...
            <div className="text-center mb-8">
              <h1 className="font-impact text-4xl text-white tracking-wide mb-2">
                HERO<span className="gradient-text">MINT</span>
              </h1>
              <p className="text-[#94A3B8] text-lg">
                Entre para receber suas imagens épicas
              </p>
            </div>
            ...
            <div className="bg-[#0F172A] border border-[#1E293B] rounded-2xl p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-[#94A3B8] text-sm">
                  Conecte-se com Google para receber suas imagens diretamente no seu Drive
                </p>
              </div>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full bg-white text-black font-medium py-4 px-6 rounded-xl hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 mb-6"
              >
                {isLoading ? (
